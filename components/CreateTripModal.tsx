    ...
    <Modal open={open} onClose={onClose} title="New Trip">
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <Input label="Start date" id="startDate" type="date" value={form.startDate} onChange={e => set("startDate", e.target.value)} required />
          <Input label="End date" id="endDate" type="date" value={form.endDate} onChange={e => set("endDate", e.target.value)} required />
        </div>
